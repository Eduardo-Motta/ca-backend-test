...
namespace Nexer.Finance.UnitTests.Nexer.Finance.Domain.Services.Customers
{
    public class CreateCustomerServiceTest
    {
        ...
        {
            var entity = new CustomerEntity(Guid.NewGuid(), name: "Maria Nascimento", email: "maria.nascimento@email.com", address: "Av. Brasil, 365 - Centro, São Paulo - SP");
        ...
        {
            var entity = new CustomerEntity(Guid.NewGuid(), name: "Jhonny Almeida", email: "j.almeida@email.com", address: "Av. Brasil, 365 - Centro, São Paulo - SP");
            var cancellationToken = CancellationToken.None;
